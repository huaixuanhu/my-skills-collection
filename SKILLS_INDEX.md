...
| `human-ai-governance` | `0.7.4` | `cross-cutting` | `maintained` | `implicit` |
...
- Do not route for:
  - An ordinary bounded task whose existing project governance already answers the relevant questions.

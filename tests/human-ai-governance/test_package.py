...
def main() -> int:
    ...
    assert "Skill version: `0.7.9`" in skill
    assert "Generated/adapted from human-ai-governance v0.7.9" in skill
    ...
    for relative_path in (
        ...
        assert "v0.7.9" in text, relative_path
    ...
    print("PASS: v0.7.9 package regression checks passed.")
    return 0

...
def init_repo(root: Path, marker: str = "0.6.0") -> None:
    run(["git", "init", "-q"], root)
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="governance-v060-") as temp:
        base = Path(temp)
    ...
    print("PASS: v0.6.0 preflight behavior tests passed.")
    return 0
